...
public class P_get_cursor_rowtype_arguments {
	...
	public static class Acur_rowtype {
		...
		public Double fld_numeric_float_null;

		public void setFld_numeric_float_null(Double fld_numeric_float_null) {
			this.fld_numeric_float_null = fld_numeric_float_null;
		}

		public Double getFld_numeric_float_null() {
			return fld_numeric_float_null;
		}
		
		
		
		public Double fld_numeric_float_value;

		public void setFld_numeric_float_value(Double fld_numeric_float_value) {
			this.fld_numeric_float_value = fld_numeric_float_value;
		}

		public Double getFld_numeric_float_value() {
			return fld_numeric_float_value;
		}
		...
		public String fld_clob;

		public void setFld_clob(String fld_clob) {
			this.fld_clob = fld_clob;
		}

		public String getFld_clob() {
			return fld_clob;
		}
		
		
		
		public String fld_clob_null;

		public void setFld_clob_null(String fld_clob_null) {
			this.fld_clob_null = fld_clob_null;
		}

		public String getFld_clob_null() {
			return fld_clob_null;
		}
		
		
		
		public byte[] fld_blob;

		public void setFld_blob(byte[] fld_blob) {
			this.fld_blob = fld_blob;
		}

		public byte[] getFld_blob() {
			return fld_blob;
		}
		
		
		
		public byte[] fld_blob_null;

		public void setFld_blob_null(byte[] fld_blob_null) {
			this.fld_blob_null = fld_blob_null;
		}

		public byte[] getFld_blob_null() {
			return fld_blob_null;
		}
	...
	public List < Acur_rowtype >  acur_rowtype;

        public void setAcur_rowtype(List < Acur_rowtype >  acur_rowtype) {
            this.acur_rowtype = acur_rowtype;
        }
    
        public List < Acur_rowtype >  getAcur_rowtype() {
            return acur_rowtype;
        }
